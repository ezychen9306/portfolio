...
# 添加远程仓库
git remote add origin https://github.com/Enzhao-Chen/portfolio.git
...
5. **等待部署**
   - 等待 1-2 分钟
   - 页面会显示：`Your site is live at https://Enzhao-Chen.github.io/portfolio/`
...
1. 推送成功后，访问：https://github.com/Enzhao-Chen/portfolio
